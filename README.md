[![build](https://github.com/opspec-pkgs/postgresql.db.waitready/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/postgresql.db.waitready/actions/workflows/build.yml)
